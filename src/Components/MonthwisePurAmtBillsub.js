...
export class MPAB extends React.Component {
    ...
    getEmployeeList() {
        ...
        //e.preventDefault();
        axios.post('http://webapi.local/Api/Misrct_new1/MonthWisePurchaseAmountBillsub', data).then(response => {
    ...
    onsubmit = (e) => {
        ...
        axios.post(`http://webapi.local/Api/Misrct_new1/MonthWisePurchaseAmountBillsub`, data)
            .then(response => {
