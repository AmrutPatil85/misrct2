...
export class MPOAS extends React.Component {
    ...
    getEmployeeList() {
        ...
        //e.preventDefault();
        axios.post('http://webapi.local/Api/Misrct_new1/MonthWisePurchaseOrderAmount', data).then(response => {
    ...
    onsubmit = (e) => {
        ...
        axios.post(`http://webapi.local/Api/Misrct_new1/MonthWisePurchaseOrderAmount`, data)
            .then(response => {
