...
export class MPOQS extends React.Component {
    ...
    getEmployeeList() {
        ...
        //e.preventDefault();
        axios.post('http://webapi.local/Api/Misrct_new1/MonthWisePurchaseOrderQuantityWeight', data).then(response => {
    ...
    onsubmit = (e) => {
        ...
        axios.post(`http://webapi.local/Api/Misrct_new1/MonthWisePurchaseOrderQuantityWeight`, data)
            .then(response => {
